...
// Complete function to check targetHash across each 
// length: length for the word
// targetHash: hash to check for the target word
// Success, Failure, End 
...
let alllettersdigits = "9876543210ZYXWVUTSRQPONMLKJIHGFEDCBAzyxwvutsrqponmlkjihgfedcba";
	...
	while (true) {
		...
		// possible char in the charset back to the stack
			...
			for (var i = lowerChar.length / 2; i < lowerChar.length; i++) {
